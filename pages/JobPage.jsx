...
const JobPage =() =>{
    ...
    type: "",
    Status: "",
    numberOfPositions: "",//starting from here
    startDate: "",
    expectedEndDate: "",
    actualEndDate: "",
    workMode: "",
    ...
    maxExpeirienceRequired: "",
    attachJD: "",//Button to upload file
...
const handleSubmit = async (e) => {
  ...
  for (const key in jobData) {
    if (key === "attachJD") {
      if (jobData.attachJD) {
        formData.append("attachJD", jobData.attachJD);
      }
    } else {
  ...
  return (
    ...
    >
      ...
      >
        ...
        options={["Remote","Hybrid","Work from Office"]}
        onChange={handleChange}
        />
        ...
        <Input label="Maximum Experience Required (Yrs)" name="maxExperienceRequired" value={jobData.maxExpeirienceRequired} onChange={handleChange} />
          ...
          <div className="flex flex-col items-center justify-center py-5">
            ...
            {jobData.attachJD && (
              <p className="mt-2 text-sm text-green-600 font-medium">
                Selected: {jobData.attachJD.name}
              </p>
            )}
          </div>
          <FileInput
